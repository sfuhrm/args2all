 ...
 */
final class PicoCliOptionMapping extends Mapping<CommandLine.Option> {

    /** Creates a new instance. */
    PicoCliOptionMapping() {
        super(CommandLine.Option.class);
    }
    ...
    public ModelParameter createFrom(final ModelParameter modelParameter,
        ...
        modelParameter.getNames().addAll(Arrays.asList(parameter.names()));
